...
public class adviceDAO {
	...
	public int getListCount(String items, String text) {
		...
		if (items == null && text == null)
			...
			sql = "SELECT   count(*) FROM boardTBL where " + items + " like '%" + text + "%'";
	...
	//테이블의 레코드 가져오기
	public ArrayList<adviceDTO> getBoardList(int page, int limit, String items, String text) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		...
		if (items == null && text == null)
			...
			sql = "SELECT  * FROM boardTBL WHERE " + items + " like '%" + text + "%' ORDER BY num DESC ";

		ArrayList<adviceDTO> list = new ArrayList<adviceDTO>();
	...
	//테이블에 새로운 글 삽입하기
	public void insertBoard(adviceDTO board)  {
	...
	public void updateHit(int num) {
		...
		try {
			...
			String sql = "select hit from boardTBL where num = ? ";
			pstmt = conn.prepareStatement(sql);
			pstmt.setInt(1, num);
			rs = pstmt.executeQuery();
			int hit = 0;
			...
			sql = "update boardTBL set hit=? where num=?";
			pstmt = conn.prepareStatement(sql);		
			pstmt.setInt(1, hit);
			pstmt.setInt(2, num);
			pstmt.executeUpdate();
	...
	//선택된 글 상세 내용 가져오기
	public adviceDTO getBoardByNum(int num, int page) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		adviceDTO board = null;
	...
	//선택된 글내용 수정하기
	public void updateBoard(adviceDTO board) {

		Connection conn = null;
		PreparedStatement pstmt = null;
	
		try {
			String sql = "update boardTBL set name=?, subject=?, content=? where num=?";
